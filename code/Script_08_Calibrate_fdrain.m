...
load('../data/outputs/fd=cal_zwt_annual.mat','zwtyr');
...
[R2(1),RMSE(1),NSE(1),PBIAS(1),MSE,NSE1] = estimate_evaluation_metric(fan8th(ind),zwt_def(ind));
...
set(gca,'YDir','normal');
ylim([-60 90]);
ind1 = find(zwt_cal > fan8th & (zwt_cal > 8.8 & zwt_cal < 8.88));

...
for j = 1 : length(C{1})
    ...
    fout = ['/compyfs/xudo627/Land_Ocean_Coupling/MERIT_bathtub/' tile(1:8) 'bathtub.mat'];
    fout2 = ['/compyfs/xudo627/Land_Ocean_Coupling/MERIT_bathtub/' tile(1:8) 'dem_mu.mat'];

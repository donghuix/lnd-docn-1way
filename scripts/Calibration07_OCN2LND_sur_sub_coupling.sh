...
CASE_NAME=Calibration07_OCN2LND_sur_sub_coupling_${GIT_HASH}.`date "+%Y-%m-%d-%H%M%S"`
...
EOF
cat >> user_nl_elm << EOF
fsurdat = '/compyfs/xudo627/lnd-docn-1way/inputdata/surfdata_global_coastline_merit_90m_fd10.0_c221109.nc'
